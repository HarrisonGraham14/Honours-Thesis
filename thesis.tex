...
\newcommand{\lnote}[1]{\llap{$#1$\hspace{2cm}}}
\newcommand{\rnote}[1]{\rlap{\hspace{2cm}$#1$}}
...
For our purposes, we are concerned with integer solutions of forms with integer coefficients. 
...
It can be shown that this form does not represent the number 1, though it is not immediately clear how to prove this.

The questions which motivated the early study of these forms were as follows;
