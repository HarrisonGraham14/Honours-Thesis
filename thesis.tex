...
Therefore, we must have $\disc$ equivalent to 1 or 0 modulo 4.
...
Hence we see that properly equivalent forms have equal discriminants.
...
It is known that such an ideal can be expressed using at most two generators \cite{}.
