...
We call forms with $b^2 -4ac < 0$ \textbf{positive definite} or \textbf{negative definite}, depending on whether they output positive or negative values.
...
First, note that the discriminant of the form found in \eqref{eq-ideal-norm-form} is given by
\begin{align*}
...
\begin{proof}
    ...
    For $I$ to be an ideal, it must be closed under addition and under multiplication by elements of $\order_\Delta$.
    ...
    Hence, we require $n \divides m$ and $n \divides l$.
